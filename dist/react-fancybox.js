...
var react_fancybox_exports = {};
__export(react_fancybox_exports, {
  ReactFancybox: () => ReactFancybox
});
module.exports = __toCommonJS(react_fancybox_exports);
...
function ReactFancybox({
  ...
  if (setFancyboxIsActive) {
    import_ui.Fancybox.defaults.on = {
      init: () => {
  ...
  React.useEffect(() => {
    ...
    import_ui.Fancybox.bind(container, delegate, {
      ...defaultOptions,
      ...options
    });
    return () => {
      import_ui.Fancybox.unbind(container);
    };
  });
  return /* @__PURE__ */ React.createElement("div", { ...props, ref: containerRef }, children);
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  ReactFancybox
});
//# sourceMappingURL=react-fancybox.js.map